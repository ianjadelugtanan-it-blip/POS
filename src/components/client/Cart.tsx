      ...
      {clientCart.length === 0 ? (
        ...
        <div className="flex flex-col lg:flex-row gap-12">
          ...
          <div className="flex-1 space-y-6">
            <div className="hidden md:grid grid-cols-12 gap-4 text-xs font-bold text-gray-400 uppercase tracking-widest pb-4 border-b border-gray-100">
          ...
          <div className="w-full lg:w-96 flex-shrink-0">
            <div className="bg-gray-50 rounded-3xl p-8 border border-gray-100 sticky top-28">
               ...
               <button
                 ...
                 className="w-full px-8 py-4 rounded-xl flex items-center justify-center gap-2 font-bold transition-all shadow-xl shadow-gray-900/20 bg-gray-900 text-white hover:bg-black hover:scale-[1.02] active:scale-[0.98]"
               >
                 Proceed to Checkout
